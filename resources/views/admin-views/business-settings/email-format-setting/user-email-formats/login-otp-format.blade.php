                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_receive_an_OTP_every_time_they_log_in_to_their_account_via_the_Customer_App_or_Website.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_User_login_mail?')}}','{{translate('Want_to_disable_User_login_mail?')}}',`<p>{{translate('If_enabled,_customers_will_receive_a_login_OTP_email_every_time_they_log_in_to_their_account.')}}</p>`,`<p>{{translate('If_disabled,_customers_will_not_receive_any_OTP_email_during_Login.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
