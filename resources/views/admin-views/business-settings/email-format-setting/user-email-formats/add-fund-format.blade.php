                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_receive_an_automated_mail_from_the_system_when_Admin_add_fund_to_their_Wallet.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_add_fund_mail?')}}','{{translate('Want_to_disable_add_fund_mail?')}}',`<p>{{translate('If_enabled,_customers_will_receive_an_email_when_Admin_adds_funds_to_their_wallet.')}}</p>`,`<p>{{translate('If_disabled,_Customers_will_not_receive_an_email_on_Added_Funds.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
