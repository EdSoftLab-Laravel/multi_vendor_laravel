                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_receive_an_automated_mail_from_the_system_if_the_Admin_rejects_their_Refund_Request.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Refund_Request_Denied_mail?')}}','{{translate('Want_to_disable_Refund_Request_Denied_mail?')}}',`<p>{{translate('If_enabled,_Customers_will_receive_a_mail_when_Admin_rejects_their_Refund_Request.')}}</p>`,`<p>{{translate('If_disabled,_Customers_will_not_receive_any_mail_for_Refund_Request_rejection.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
