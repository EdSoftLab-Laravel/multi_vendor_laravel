                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_receive_an_automated_email_with_an_OTP_to_confirm_their_registration.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_User_Registration_mail?')}}','{{translate('Want_to_disable_User_Registration_mail?')}}',`<p>{{translate('If_enabled,_Customers_will_receive_OTP_in_their_mail_to_confirm_registration.')}}</p>`,`<p>{{translate('If_disabled,_Customers_will_not_receive_any_email_on_registration_OTP.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
