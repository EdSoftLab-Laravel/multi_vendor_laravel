                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_Customer_clicks_on_‘Forgot_Password’_during_login,_an_automated_email_will_be_sent_with_a_Reset_Password_Link.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Forget_Password_mail?')}}','{{translate('Want_to_disable_Forget_Password_mail?')}}',`<p>{{translate('If_enabled,_the_Customer_will_receive_an_automated_email_with_a_Reset_Password_link.')}}</p>`,`<p>{{translate('If_disabled,_the_Deliveryman_will_not_receive_any_for_password_reset.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
