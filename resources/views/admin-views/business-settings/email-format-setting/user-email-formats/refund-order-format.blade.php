                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('Customers_will_get_an_automated_email_when_they_receive_a_refund_to_their_wallet_from_Admin_with_refund_details.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Refund_Order_mail?')}}','{{translate('Want_to_disable_Refund_Order_mail?')}}',`<p>{{translate('If_enabled,_Customers_will_get_an_automated_email_when_they_receive_a_refund.')}}</p>`,`<p>{{translate('If_disabled,_Customers_will_not_receive_any_mail_on_Refund_Orders.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
