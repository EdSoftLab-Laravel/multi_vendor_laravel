                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_store_requests_for_a_withdrawal,_admin_will_receive_an_automated_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Withdraw_Request_mail?')}}','{{translate('Want_to_disable_Withdraw_Request_mail?')}}',`<p>{{translate('If_enabled,_admin_will_receive_an_email_when_a_store_requests_a_withdrawal.')}}</p>`,`<p>{{translate('If_disabled,_admin_will_not_receive_an_email_when_a_store_requests_a_withdrawal.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
