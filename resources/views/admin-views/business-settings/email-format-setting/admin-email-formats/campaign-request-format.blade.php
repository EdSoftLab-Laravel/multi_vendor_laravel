    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','campaign_request_mail_status_admin')->first())
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_store_requests_to_join_campaign_an_automated_email_will_be_sent_to_the_admin.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Campaign_Request_mail?')}}','{{translate('Want_to_disable_Campaign_Request_mail?')}}',`<p>{{translate('If_enabled,_the_admin_will_receive_a_mail_when_a_store_requests_to_join_a_campaign.')}}</p>`,`<p>{{translate('If_disabled,_the_admin_will_not_receive_mail_when_a_store_requests_to_join_a_campaign.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
