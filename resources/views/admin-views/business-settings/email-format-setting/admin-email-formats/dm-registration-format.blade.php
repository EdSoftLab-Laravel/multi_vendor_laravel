                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Deliveryman_registers_from_the_customer_App_or_Website_or_Deliveryman_App,_Admin_receive_an_automated_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Delivery_Man_Registration_mail?')}}','{{translate('Want_to_disable_Delivery_Man_Registration_mail?')}}',`<p>{{translate('If_enabled,_the_admin_will_get_an_automated_email_when_a_deliveryman_registers.')}}</p>`,`<p>{{translate('If_disabled,_the_admin_will_not_get_an_automated_email_when_a_deliveryman_registers.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
