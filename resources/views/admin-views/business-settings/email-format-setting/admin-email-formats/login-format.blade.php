                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_user_login_from_their_respective_system,_the_Admin_gets_notified_via_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Login_mail?')}}','{{translate('Want_to_disable_Login_mail?')}}',`<p>{{translate('If_enabled,_Admin_will_receive_an_automated_email_on_every_login_from_all_users.')}}</p>`,`<p>{{translate('If_disabled,_Admin_will_not_receive_an_automated_email_on_every_login_of_users.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
