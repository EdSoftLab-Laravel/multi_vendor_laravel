    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','withdraw_approve_mail_status_store')->first())
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_Store_requests_for_a_withdrawal_and_Admin_approves_it,_the_Store_will_get_an_automated_Withdraw_Approval_email_from_the_system') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Withdraw_approve_mail?')}}','{{translate('Want_to_disable_Withdraw_approve_mail?')}}',`<p>{{translate('If_enabled,_Stores_will_receive_an_approval_mail_for_requesting_a_withdrawal.')}}</p>`,`<p>{{translate('If_disabled,_Stores_will_not_receive_any_Withdraw_Approval_mail.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
