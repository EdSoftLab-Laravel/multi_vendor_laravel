    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Models\BusinessSetting::where('key','campaign_deny_mail_status_store')->first())
                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_a_Store_requests_to_join_a_Campaign_and_Admin_rejects_their_joining_request,_they_will_get_an_automated_Rejection_email_from_the_system.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Campaign_deny_mail?')}}','{{translate('Want_to_disable_Campaign_deny_mail?')}}',`<p>{{translate('If_enabled,_Stores_will_receive_an_email_on_campaign_joining_Rejection.')}}</p>`,`<p>{{translate('If_disabled,_Stores_will_not_receive_any_email_on_campaign_joining_Rejection.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
