                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Store/Admin_wants,_they_can_suspend_a_Deliveryman’s_account._If_a_Store_or_Admin_suspends_a_Deliveryman’s_account,_he_will_receive_an_automated_email.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Suspend_mail?')}}','{{translate('Want_to_disable_Suspend_mail?')}}',`<p>{{translate('If_enabled,_deliverymen_will_receive_an_email_for_account_suspension.')}}</p>`,`<p>{{translate('If_disabled,_deliverymen_will_not_receive_an_email_for_account_suspension.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
