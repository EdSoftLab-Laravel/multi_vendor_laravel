                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_or_Store_collects_cash_from_a_Deliveryman,_he_will_receive_an_automated_email_from_the_system_showing_how_much_cash_is_collected.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_cash_collect_mail?')}}','{{translate('Want_to_disable_cash_collect_mail?')}}',`<p>{{translate('If_enabled,_the_Deliveryman_will_receive_an_email_after_the_Admin/Store_collects_cash_from_him.')}}</p>`,`<p>{{translate('If_disabled,_the_Deliveryman_will_not_receive_any_email_on_Cash_Collection.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
