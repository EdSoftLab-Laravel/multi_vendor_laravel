                    ...
                    <div class="card-body">
                        ...
                        <span class="form-label-secondary text--primary" data-toggle="tooltip" data-placement="right" data-original-title="{{ translate('If_Admin_accepts_a_Deliveryman’s_self-registration,_the_Deliveryman_will_get_an_automatic_approval_mail.') }}">
                            ...
                            <label class="toggle-switch toggle-switch-sm">
                                <input type="checkbox" class="status toggle-switch-input" onclick="toogleStatusModal(event,'mail-status','place-order-on.png','place-order-off.png','{{translate('Want_to_enable_Delivery_Man_approve_mail?')}}','{{translate('Want_to_disable_Delivery_Man_approve_mail?')}}',`<p>{{translate('If_enabled,_Deliverymen_will_get_a_confirmation_email_when_registration_is_approved_by_the_Admin.')}}</p>`,`<p>{{translate('If_disabled,_Deliverymen_will_not_get_a_registration_approval_email.')}}</p>`)" id="mail-status" {{$mail_status == '1'?'checked':''}}>
