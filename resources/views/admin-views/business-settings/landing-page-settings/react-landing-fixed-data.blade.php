                        ...
                        <div class="row g-3">
                            <div class="col-md-7">
                                ...
                                <label class="upload-img-3 m-2 d-block">
                                    ...
                                    <div class="img">
                                        <img src="{{asset('storage/promotional_banner')}}/{{ $fixed_promotional_banner['value']??'' }}" onerror='this.src="{{asset('public/assets/admin/img/upload-4.png')}}"' class="vertical-img mw-100 vertical" alt="">
                                    </div>
