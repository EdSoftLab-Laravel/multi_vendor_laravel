                                ...
                                <div class="col-md-12">
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <input type="text" name="download_user_app_title[]" class="form-control" placeholder="{{translate('messages.title_here...')}}">
                                        </div>
                                        <div class="col-12">
                                            <label class="form-label">{{translate('Sub Title')}}</label>
                                            <input type="text" name="download_user_app_sub_title[]" class="form-control" placeholder="{{translate('messages.sub_title_here...')}}">
                                        </div>
                                    </div>
                                </div>
                                    <input type="hidden" name="lang[]" value="default">
                                    ...
                                    <div class="form-group mb-md-0">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <label class="toggle-switch toggle-switch-sm m-0">
                                                <input type="checkbox" name="playstore_url_status" onclick="toogleModal(event,'play-store-dm-status','play-store-on.png','play-store-off.png','{{translate('Want_to_enable_the_Play_Store_button_for_User_App?')}}','{{translate('Want_to_disable_the_Play_Store_button_for_User_App?')}}',`<p>{{translate('If_enabled,_the_User_app_download_button_will_be_visible_on_React_Landing_page.')}}</p>`,`<p>{{translate('If_disabled,_this_button_will_be_hidden_from_the_React_landing_page.')}}</p>`)" id="play-store-dm-status" class="status toggle-switch-input" value="1" {{(isset($download_user_app_links) && $download_user_app_links['playstore_url_status'])?'checked':''}}>
                                ...
                                <div class="__bg-F8F9FC-card">
                                    <div class="form-group mb-md-0">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            ...
                                            <label class="toggle-switch toggle-switch-sm m-0">
                                                <input type="checkbox" name="apple_store_url_status" onclick="toogleModal(event,'apple-dm-status','apple-on.png','apple-off.png','{{translate('Want_to_enable_the_App_Store_button_for_User_App?')}}','{{translate('Want_to_disable_the_App_Store_button_for_User_App?')}}',`<p>{{translate('If_enabled,_the_User_app_download_button_will_be_visible_on_React_Landing_page.')}}</p>`,`<p>{{translate('If_disabled,_this_button_will_be_hidden_from_the_React_landing_page.')}}</p>`)" id="apple-dm-status" class="status toggle-switch-input" value="1" {{(isset($download_user_app_links) && $download_user_app_links['apple_store_url_status'])?'checked':''}}>
                                                <span class="toggle-switch-label text mb-0">
                                                    <span class="toggle-switch-indicator"></span>
                                                </span>
                                            </label>
